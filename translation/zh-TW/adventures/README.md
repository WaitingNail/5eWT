...
《深水城：龍金劫》（Waterdeep: Dragon Heist，WDH）已由其他工作合併至主分支。本次接續整合《維克那：妖眼魔窟》與《維克那：毀滅前夕》，以主分支 `271791433129b95309790197f2e92a1b2229bf1c` 為基底，保留載具與靈能頁面的新修正。譯文、術語、來源保護的校訂及檢查資料都隨戰役分支提交；本次不更新 `main`。網站目前的部署工作流程只由 `main` 的推送或手動執行觸發。
