...
console.log("zh-TW interface, Class, core-rules, Quick Reference, spells, character-options, items, monsters, Bastions, cults/boons, reference pages, CoS/Tyranny of Dragons/Waterdeep: Dragon Heist/Vecna/Out of the Abyss adventures, vehicles, recipes, homecrafts, psionics, and deployed image-root verification passed.");
