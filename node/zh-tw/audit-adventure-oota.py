#!/usr/bin/env python3
"""Create reproducible source-addressed inventories for Out of the Abyss."""
...
spec = importlib.util.spec_from_file_location("oota", Path(__file__).with_name("import-adventure-oota.py"))
