#!/usr/bin/env python3
"""Create reproducible source-addressed inventories for BGDIA and Tomb of Annihilation."""
...
spec = importlib.util.spec_from_file_location("frontier", Path(__file__).with_name("import-adventure-bgdia-toa.py"))
