#!/usr/bin/env python3
"""Create reproducible source-addressed inventories for Keys from the Golden Vault."""
...
spec = importlib.util.spec_from_file_location("frontier", Path(__file__).with_name("import-adventure-kftgv.py"))
